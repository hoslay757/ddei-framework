<template>
  <div>
    <div id="ddei_editor_quick_fat_item_fontfamily" :class="{'ddei_editor_quick_fat_item_fontfamily':true,'ddei_editor_quick_fat_item_fontfamily_disabled': !attrDefine }">
      ...
      <div id="ddei_editor_quick_fat_item_fontfamily_combox_dialog" class="ddei_editor_quick_fat_item_fontfamily_combox_dialog" >
...
export default {
  ...
  methods: {
    ...
    showDialog(show: boolean = false, evt) {
      let dialog = document.getElementById("ddei_editor_quick_fat_item_fontfamily_combox_dialog");
      ...
      if (dialog.style.display != "grid") {
        ...
        //获取父级控件绝对坐标
        let attrEditor = document.getElementById("ddei_editor_quick_fat_item_fontfamily");
    ...
    */
    ...
    closeDialog(evt) {
      this.expanded = false;
      let dialog = document.getElementById("ddei_editor_quick_fat_item_fontfamily");
      dialog.style.display = "none";
    },
