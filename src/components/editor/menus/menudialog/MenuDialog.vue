<template>
  <div id="ddei_editor_menu_dialog" class="ddei_editor_menu_dialog">
    <div v-show="isVisiable(menu)" :class="{ 'ddei_editor_menu_dialog_hr': menu.code == 'split', 'ddei_editor_menu_dialog_item': menu.code != 'split' }" v-for="menu in editor?.currentMenuData" @click="execMenuAction(menu,$event)">
...
.ddei_editor_menu_dialog {
  ...
  z-index: 999;
  border-radius: 4px;
  box-shadow: -3.0px 3.0px 3.0px hsl(0deg 0% 0% /0.25)
}
