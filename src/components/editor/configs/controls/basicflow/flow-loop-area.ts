          ...
          let weight = 20
            switch(i){
              ...
              case 3:
                ...
                sample.x = pvs[0].x
                pvs.push({x:sample.x-weight,y:sample.y,select:1,clip:1,stroke:1,fill:1});
                pvs.push({x:sample.x,y:sample.y+weight,select:1,clip:1,text:1,stroke:1,fill:1,end:1});
