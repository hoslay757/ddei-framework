...
export const styles = {
  ...
  'children': [

    {
      ...
      'defaultValue': 'A4',
      'cascadeDisplay': { '自定义': { show: ['paper.direct', 'paper.width', 'paper.height', 'paper.unit'] }, notempty: { show: ['paper.direct'], hidden: ['paper.width', 'paper.height', 'paper.unit'] }, empty: { hidden: ['paper.direct', 'paper.width', 'paper.height', 'paper.unit'] } },
      'type': 1,
      'orderNo': 1,
      'visiable': true
    },
